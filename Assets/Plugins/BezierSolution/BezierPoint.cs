...
namespace BezierSolution
{
	public class BezierPoint : MonoBehaviour
	{
		...
		[SerializeField]
		[HideInInspector]
		private Vector3 m_precedingControlPointLocalPosition = Vector3.back;
		...
		[SerializeField]
		[HideInInspector]
		private Vector3 m_followingControlPointLocalPosition = Vector3.forward;
		...
		public void Reset()
		{
			...
			precedingControlPointLocalPosition = Vector3.back;
			followingControlPointLocalPosition = Vector3.forward;
